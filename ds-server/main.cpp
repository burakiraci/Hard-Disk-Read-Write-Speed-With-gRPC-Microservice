...
public:
	grpc::Status MeasureSpeed(grpc::ServerContext* context, const diskspeed::SpeedRequest* request, diskspeed::SpeedResponse* response) override {
...
void RunServer() {
	...
	std::cout << "Server baslatildi " << server_address << std::endl;
	server->Wait();
}
